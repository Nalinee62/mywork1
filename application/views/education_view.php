  ...
  <body>
    ...
    <nav class="w3-sidebar w3-green w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
      ...
      <div class="w3-bar-block">
        <a href="<?php echo site_url('Satang/home');?>" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">About Me</a> 
        <a href="#education" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Education</a>
        <a href="<?php echo site_url('Satang/activity');?>" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Activity</a>
      </div>
    </nav>
    ...
    <div class="w3-overlay w3-hide-large" onclick="w3_close()" style="cursor:pointer" title="close side menu" id="myOverlay"></div>
      ...
      <div class="w3-container" style="margin-top:80px" id="my picture">
        <h1 class="w3-jumbo"><b>This is My Education!</b></h1>
